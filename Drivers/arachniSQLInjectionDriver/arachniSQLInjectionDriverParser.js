...
// console.log("All Lines split:" + lines);
    var sendData = {
    "metadata": {
        "reportname": "Roudra Security Automation Framework Arachni SQL Injection Report",
        "scanid": data.scanID,
        "target": host,
        "toolname": "Arachni SQL Injection",
        "tooltype": "SQL Injection and scanning tool",
        "info": "SQL Injection and scanning tool"
    },
    "reportdata": []
  }
 ...
 var data;
  for(var i=0;i<lines.length;i++) {
    ...
    if(lines[i].match(" 0 issues were detected")) {
      ...
      repData = {};
      repData.label = "No SQL Injection vulnerability found";
      repData.desc = "SQL Injection  was not found in Target";
